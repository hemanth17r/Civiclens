...
export default function OnboardingModal() {
    ...
    const shouldShow = !loading && !!user && profileChecked && !userProfile?.handle;
            ...
            {shouldShow && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        animate="animate"
                        exit="exit"
                        className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden p-8 text-center"
                    >
