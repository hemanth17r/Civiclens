                ...
                <>
                    ...
                    >
                        <div className="pb-4 border-b border-gray-100 flex items-center justify-between">
                            ...
                            <motion.button {...tapScale.icon} onClick={onClose} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                        ...
                        <div className="pt-6">
                            ...
                            <div className="flex justify-around">
                                ...
                                {shareOptions.map((option) => {
                                    const content = (
                                        <>
                                            <div className={clsx("w-14 h-14 rounded-full flex items-center justify-center shadow-md", option.color)}>
                                                <option.icon size={26} />
                                            </div>
