            ...
            <header className="h-16 bg-white flex items-center px-6 justify-between fixed top-0 left-0 right-0 z-30">
                ...
                <div className="flex items-center gap-3 justify-end ml-auto">
                    <motion.button
                        ...
                        className="flex flex-row items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-semibold shadow-sm shadow-blue-500/20 cursor-pointer"
                    >
                    ...
                    {user ? (
                        ...
                        <motion.button
                            ...
                            className="text-sm font-bold text-gray-700 hover:bg-gray-100 px-4 py-2 rounded-full transition-colors cursor-pointer"
                        >
                            Sign In
                        </motion.button>
                    )}
